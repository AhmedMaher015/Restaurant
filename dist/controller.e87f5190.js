...
},{"../internals/fails":"node_modules/core-js/internals/fails.js","../internals/object-create":"node_modules/core-js/internals/object-create.js","../internals/object-get-prototype-of":"node_modules/core-js/internals/object-get-prototype-of.js","../internals/create-non-enumerable-property":"node_modules/core-js/internals/create-non-enumerable-property.js","../internals/well-known-symbol":"node_modules/core-js/internals/well-known-symbol.js","../internals/is-pure":"node_modules/core-js/internals/is-pure.js"}],"node_modules/core-js/internals/create-iterator-constructor.js":[function(require,module,exports) {
'use strict';
...
var getJson = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, requestOptions) {
    var res, data;
...
exports.API_URL_LOGIN = API_URL_LOGIN;
var API_URL_SIGNUP = "".concat(API_URL, "users/signup");
exports.API_URL_SIGNUP = API_URL_SIGNUP;
var API_URL_SEARCH = "".concat(API_URL, "recipes/search?s=");
exports.API_URL_SEARCH = API_URL_SEARCH;
var API_URL_RECIPES = "".concat(API_URL, "recipes/");
exports.API_URL_RECIPES = API_URL_RECIPES;
var API_URL_CATEGORIES = "".concat(API_URL, "categories/");
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            data = _context.sent;
            state.recipes = _toConsumableArray(data.data.data);
...
var loadRecipe = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(id) {
    var data, _data$data$data, recipe;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            data = _context2.sent;
            _data$data$data = _slicedToArray(data.data.data, 1), recipe = _data$data$data[0];
            state.recipe = {
              id: recipe._id,
              name: recipe.name,
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            data = _context3.sent;
            state.categories = _toConsumableArray(data.data.data);
            _context3.next = 10;
            break;
...
var loadSearchResults = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(recipeName) {
    var data;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            state.search = {
              target: recipeName,
              results: _toConsumableArray(data.data.data)
            };
            _context4.next = 10;
            break;
        ...
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return helpers.getJson(config.API_URL_ORDERS, {
              method: 'GET',
              headers: {
                Authorization: "Bearer ".concat(state.profile.token),
...
var recipeView = /*#__PURE__*/function () {
  function recipeView() {
    ...
    _defineProperty(this, "_parent", document.getElementById('ingredients'));

    _defineProperty(this, "_modal", document.getElementById('detailsModal'));
    ...
    window.addEventListener('click', this.closeModalOnClickWindow.bind(this)); // add event to close btns

    this._closeBtns.forEach(function (btn) {
      return btn.addEventListener('click', _this.closeRecipeModal.bind(_this));
    });
  }
  ...
  _createClass(recipeView, [{
    ...
    key: "closeRecipeModal",
    value: function closeRecipeModal() {
    ...
    value: function addToFavorite() {
      var _favorites = JSON.parse(localStorage.getItem('favorite')) || [];
      ...
      var IsItInFavorites = function IsItInFavorites(recipeId) {
        ...
        _favorites.forEach(function (id) {
...
},{}],"src/js/views/categoriesView.js":[function(require,module,exports) {
"use strict";
...
var categoriesView = /*#__PURE__*/function () {
  function categoriesView() {
    _classCallCheck(this, categoriesView);

    _defineProperty(this, "_parent", document.querySelector('.categories'));

    _defineProperty(this, "_createCategory", function (category) {
      return "\n            <button class=\"btn btn-outline-danger\" value=".concat(category._id, ">").concat(category.name, "</button>\n        ");
    });
  }

  _createClass(categoriesView, [{
    key: "renderCategorys",
    value: function renderCategorys(categorys) {
      var _this = this;

      categorys.forEach(function (category) {
        // create category
        var categoryBtn = _this._createCategory(category); // render category btn


        _this._parent.insertAdjacentHTML('afterbegin', categoryBtn);
      });
    }
  }]);
...
exports.default = _default;
},{}],"src/js/views/recipesView.js":[function(require,module,exports) {
"use strict";
...
var recipesView = /*#__PURE__*/function () {
  ...
  _createClass(recipesView, [{
    ...
    key: "_createRecipe",
    value: function _createRecipe(recipe) {
      var html = "\n      <div class=\"col-sm-12 col-md-6 col-lg-4\">\n        <div class=\"card\" id=".concat(recipe._id, ">\n          <div class=\"card-body\">\n            <div class=\"row recipe\">\n              <div class=\"col-8\">\n                <div class=\"recipe-content\">\n                  <h4 class=\"recipe-title recipe-name\">").concat(recipe.name, "</h4>\n                  <p class=\"recipe-text\">\n                    ").concat(recipe.category, "\n                  </p>\n                  <p class=\"recipe-price\">").concat(recipe.price, "$</p>\n                </div>\n              </div>\n              <div class=\"col-4 recipe-img\">\n                <img\n                  src=").concat(recipe.imageCover, "\n                  alt=\"").concat(recipe.name, " image\"\n                  class=\"recipe-asset\"\n                />\n              </div>\n            </div>\n          </div>\n        </div>\n    </div>\n      ");

      this._parent.insertAdjacentHTML('afterbegin', html);
    }
  }, {
    key: "_createPopular",
    value: function _createPopular(recipe) {
    ...
    value: function addHandler(handler) {
      ...
      recipeCards.forEach(function (card) {
        return card.addEventListener('click', handler);
      });
    }
  }]);
...
var searchView = /*#__PURE__*/function () {
  function searchView() {
    ...
    _defineProperty(this, "_parent", document.querySelector('.search .search__results'));

    _defineProperty(this, "_searchBtn", document.querySelector('.search .search__btn'));

    _defineProperty(this, "_searchField", document.querySelector('.search .search__field'));
  }
  ...
  _createClass(searchView, [{
    ...
    value: function renderSearchResults(results) {
      ...
      results.forEach(function (recipe) {
        return _this._createSearchRecipe(recipe);
      });
    }
  }, {
    key: "_createSearchRecipe",
    value: function _createSearchRecipe(recipe) {
      var html = "\n          <div class=\"col-sm-12 col-md-6 col-lg-4\">\n            <div class=\"card\" id=".concat(recipe._id, ">\n              <div class=\"card-body\">\n                <div class=\"row recipe\">\n                  <div class=\"col-8\">\n                    <div class=\"recipe-content\">\n                      <h4 class=\"recipe-title recipe-name\">").concat(recipe.name, "</h4>\n                      <p class=\"recipe-text\">\n                        ").concat(recipe.category, "\n                      </p>\n                      <p class=\"recipe-price\">").concat(recipe.price, "$</p>\n                    </div>\n                  </div>\n                  <div class=\"col-4 recipe-img\">\n                    <img\n                      src=").concat(recipe.imageCover, "\n                      alt=\"").concat(recipe.name, " image\"\n                      class=\"recipe-asset\"\n                    />\n                  </div>\n                </div>\n              </div>\n            </div>\n        </div>\n          ");
    ...
    value: function addHandler(handler) {
      ...
      this._searchBtn.addEventListener('click', function () {
        return handler(_this2._searchField.value);
      });
    }
  }, {
    key: "_clearParent",
    value: function _clearParent() {
      this._parent.innerHTML = '';
    }
  }, {
    key: "addHandlerToCardsSearch",
    value: function addHandlerToCardsSearch(handler) {
...
var cartView = /*#__PURE__*/function () {
  ...
  _createClass(cartView, [{
    ...
    key: "addHandlerRemove",
    value: function addHandlerRemove() {
      var _this = this;

      var cartBtns = this._modal.querySelectorAll('.remove-cart');
    ...
    key: "addHandlerOrderNow",
    value: function addHandlerOrderNow(handler) {
      var orderNowBtn = this._modal.querySelector('#orderNow');

      orderNowBtn.addEventListener('click', handler);
    }
  }, {
    key: "addHandlerAmount",
    value: function addHandlerAmount() {
      var _this2 = this;

      var amountInputs = this._parent.querySelectorAll('.amount');
      ...
      var subtractBtns = this._parent.querySelectorAll('.subtract');
    }
  }, {
    key: "clear",
    ...
    key: "totalSalary",
    value: function totalSalary() {
      var totalSalary = document.querySelector('#cartModal .total-salary span');
      var total = 0;

      var carts = this._modal.querySelectorAll('.row');

      if (carts.length > 0 && this._modal.classList.contains('show')) {
        carts.forEach(function (cart) {
          total += Number(cart.querySelector('.price').textContent.replace('$', '')) * Number(cart.querySelector('.amount').value);
        });
      }
    ...
    key: "storeOrders",
    value: function storeOrders() {
      var orderItems = [];

      var carts = this._parent.querySelectorAll('.row');
...
var _default = new cartView(); // addHandlerIncrementAmount() {
...
exports.default = _default;
},{}],"src/js/views/orderView.js":[function(require,module,exports) {
"use strict";
...
var orderView = /*#__PURE__*/function () {
  function orderView() {
    ...
    _defineProperty(this, "_modal", document.querySelector('#orderModal'));
  ...
  _createClass(orderView, [{
    ...
    value: function addHandler(handler) {
      ...
      var form = this._modal.querySelector('.modal__form');
      ...
      form.addEventListener('submit', function (e) {
        ...
        if (_this2.validPhoneNumber()) {
          ...
          _this2.renderError('invalid phone number');
        }
      });
    }
  }, {
    ...
    value: function renderError(err) {
      var errorLabel = this._modal.querySelector('.order-error');

      errorLabel.textContent = err;
    }
  }, {
    key: "validPhoneNumber",
    value: function validPhoneNumber() {
      var phoneNumber = document.querySelector('#phone-number');
...
exports.default = _default;
},{}],"src/js/views/orderResultView.js":[function(require,module,exports) {
"use strict";
...
var orderResultView = /*#__PURE__*/function () {
  function orderResultView() {
    var _this = this;

    _classCallCheck(this, orderResultView);

    _defineProperty(this, "_modal", document.getElementById('orderResultModal'));

    _defineProperty(this, "_parent", document.querySelector('.order-result-items'));

    _defineProperty(this, "renderResultOrder", function (data) {
      _this._parent.innerHTML = '';
      var result = "\n        <ul class=\"cart-items\">\n          <li class=\"cart-item\">\n          <div class=\"row\">\n              <div class=\"col-4\" style=\"font-weigth: bold; color: #222;\">Recipe Name</div>\n              <div class=\"col-4\" style=\"font-weigth: bold; color: #222;\">Amount</div>\n              <div class=\"col-4\" style=\"font-weigth: bold; color: #222;\">Price</div>\n          </div>\n        </li>\n        ".concat(data.orderContent.map(function (el) {
        return _this._createRecipeInfo(el);
      }).join(''), " \n        <li class=\"cart-item\">\n          <div class=\"row\" >\n            <div class=\"col-8\" style=\"font-weigth: bold; color: #222;\">Total Price</div>\n            <div class=\"col-4 total-price\" style=\"font-weigth: bold; color: green;\">").concat(data.totalPrice, "$</div>\n          </div>\n        </li> \n        </ul>\n          ");
      _this._parent.innerHTML = result;
    });
    ...
    var closeBtns = this._modal.querySelectorAll('.close');
  ...
  _createClass(orderResultView, [{
    key: "_createRecipeInfo",
    value: function _createRecipeInfo(recipe) {
      var content = "\n        <li class=\"cart-item\">\n          <div class=\"row\">\n              <div class=\"col-4 recipe-name\" >".concat(recipe.recipeName, "</div>\n              <div class=\"col-4 recipe-amount\" >").concat(recipe.recipeAmount, "</div>\n              <div class=\"col-4 recipe-price\" style=\"color: green; \">").concat(recipe.recipePrice, "$</div>\n          </div>\n          </li>\n          ");
      return content;
    }
  }, {
    key: "showModal",
...
var _default = new orderResultView();
...
var _orderResultView = _interopRequireDefault(require("./views/orderResultView.js"));

var _runtime2 = require("regenerator-runtime/runtime");
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _model.loadRecipes)();

          case 2:
            // render all recipes
            _recipesView.default.renderRecipes(_model.state.recipes); // render popular recipes


            _recipesView.default.renderPopular(_model.state.popular); // add event to recipes


            _recipesView.default.addHandler(controlRecipe); // load categories


            _context.next = 7;
            return (0, _model.loadCategories)();

          case 7:
            // render Categories
            _categoriesView.default.renderCategorys(_model.state.categories);
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            id = e.target.closest('.card').id; // get recipe
          ...
          case 3:
            // render recipe
            _recipeView.default.renderRecipe(_model.state.recipe); // show modal


            _recipeView.default.showRecipeModal();
...
var controlSearch = function controlSearch(searchWord) {
  if (!searchWord) return; // load search results

  (0, _model.loadSearchResults)(searchWord); // render search results

  _searchView.default.renderSearchResults(_model.state.search.results);
...
var showOrderModal = function showOrderModal() {
  // store carts on local storage
  _cartView.default.storeOrders(); // show order modal


  _orderView.default.showModal();
};

var controlOrder = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(orderInfo) {
    var profile, data;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 4:
            ...
            // close order modal
            _orderView.default.closeModal(); // reset cart


            _cartView.default.resetCart(); // show order result


            _orderResultView.default.showModal(); // render order result


            _orderResultView.default.renderResultOrder(data.data);
          ...
          case 11:
            ...
            _orderView.default.renderError(_context9.t0.message);
  ...
  return function controlOrder(_x6) {
...
var init = function init() {
  ...
  _cartView.default.addHandler(controlCarts); // add handler to order now btn


  _cartView.default.addHandlerOrderNow(showOrderModal); // add handler to favorite icon


  _favoriteView.default.addHandler(controlFavorites); // add handler to profile icon


  _profileView.default.addHandler(controlProfile); // add handler to order btn


  _orderView.default.addHandler(controlOrder);
...
init();
},{"../../node_modules/regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","../../node_modules/core-js/stable":"node_modules/core-js/stable/index.js","./model.js":"src/js/model.js","./config.js":"src/js/config.js","./helpers.js":"src/js/helpers.js","./views/recipeView.js":"src/js/views/recipeView.js","./views/categoriesView.js":"src/js/views/categoriesView.js","./views/recipesView.js":"src/js/views/recipesView.js","./views/searchView.js":"src/js/views/searchView.js","./views/loginView.js":"src/js/views/loginView.js","./views/signupView.js":"src/js/views/signupView.js","./views/toggleFormsView.js":"src/js/views/toggleFormsView.js","./views/loggedView.js":"src/js/views/loggedView.js","./views/cartView.js":"src/js/views/cartView.js","./views/favoriteView.js":"src/js/views/favoriteView.js","./views/profileView.js":"src/js/views/profileView.js","./views/orderView.js":"src/js/views/orderView.js","./views/orderResultView.js":"src/js/views/orderResultView.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
